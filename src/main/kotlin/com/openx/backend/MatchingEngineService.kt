...
class MatchingEngineService(
    ...
    fun match(incomingOrder: Order): Order {
        ...
        for (restingOrder in oppositeOrders) {
            ...
            val updatedResting = updateOrderFill(restingOrder, tradeQuantity)
            orderRepository.save(updatedResting)
        }
    ...
    private fun executeTrade(buyOrder: Order, sellOrder: Order, price: BigDecimal, quantity: BigDecimal) {
